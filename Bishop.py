...
class Bishop:
    ...
    def move(self, new_pos):
        ...
        if new_pos[0] < 8 and new_pos[1] < 8:
            #if difference for both hor/ver is the same, stays on diagonal
            if abs(self.pos[0] - new_pos[0]) == abs(self.pos[1] - new_pos[1]):
                ...
                if self.piece_inbetween(new_pos):
                    ...
                    if self.board[new_pos[0]][new_pos[1]] == []:
                        print("Bishop from", self.pos, "to", new_pos)
                        ...
                        print("Bishop from", self.pos, "takes", self.board[new_pos[0]][new_pos[1]].id, "on", new_pos)
                        self.board[self.pos[0]][self.pos[1]] = []
                        self.board[new_pos[0]][new_pos[1]] = self
                        self.pos = new_pos
                        return True
